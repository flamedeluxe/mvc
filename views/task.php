...
<form method="post" action="">
    ...
    <div class="form-group">
        ...
        <textarea type="text" name="text" class="form-control" rows="6" id="exampleInputText" placeholder="Text of task"></textarea>
    </div>
    <div class="form-check">
        <input type="checkbox" name="done" value="1" class="form-check-input" id="exampleCheck1">
